...
/// @nodoc
abstract class $AuthInitPageStateCopyWith<$Res> {
  factory $AuthInitPageStateCopyWith(
          AuthInitPageState value, $Res Function(AuthInitPageState) then) =
      _$AuthInitPageStateCopyWithImpl<$Res>;
}

/// @nodoc
class _$AuthInitPageStateCopyWithImpl<$Res>
    implements $AuthInitPageStateCopyWith<$Res> {
  _$AuthInitPageStateCopyWithImpl(this._value, this._then);

  final AuthInitPageState _value;
  // ignore: unused_field
  final $Res Function(AuthInitPageState) _then;
}
...
class __$$_InitStateCopyWithImpl<$Res>
    extends _$AuthInitPageStateCopyWithImpl<$Res>
...
class _$_InitState implements _InitState {
  ...
  @override
  String toString() {
    return 'AuthInitPageState.initState()';
  }
...
abstract class _InitState implements AuthInitPageState {
...
class _$_SuccessState implements _SuccessState {
  ...
  @override
  String toString() {
    return 'AuthInitPageState.successState(currentUser: $currentUser)';
  }
...
abstract class _SuccessState implements AuthInitPageState {
