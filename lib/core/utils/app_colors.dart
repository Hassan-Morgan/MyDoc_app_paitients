...
class AppColors {
  static const Color primaryBlueColor = Color(0XFF3D80FE);
  static const Color lightPrimaryBlueColor = Color(0XFF93B8FE);
  static const Color whiteColor = Color(0XFFFFFFFF);
  static const Color blackBackgroundColor = Color(0XFF0D0D0D);
  static const Color whiteBackgroundColor = Color(0XFFF8F9FE);
  static const Color redColor = Color(0XFFDA1414);
